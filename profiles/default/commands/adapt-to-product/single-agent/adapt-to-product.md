...
{{PHASE 1: @agent-os/commands/adapt-to-product/1-setup-and-information-gathering.md}}

{{PHASE 2: @agent-os/commands/adapt-to-product/2-analyze-codebase.md}}

{{PHASE 3: @agent-os/commands/adapt-to-product/3-create-mission.md}}

{{PHASE 4: @agent-os/commands/adapt-to-product/4-create-roadmap.md}}

{{PHASE 5: @agent-os/commands/adapt-to-product/5-create-tech-stack.md}}
