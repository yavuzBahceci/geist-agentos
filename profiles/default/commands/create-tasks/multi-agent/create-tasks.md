...
- `geist/specs/[this-spec]/spec.md` (if present)
- `geist/specs/[this-spec]/planning/requirements.md` (if present)
- `geist/specs/[this-spec]/planning/visuals/` and its' contents (if present)
...
✅ Tasks list created: `geist/specs/[this-spec]/tasks.md`
