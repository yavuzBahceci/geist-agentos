Now that you've gathered information about this product, use that info to create the mission document in `geist/product/mission.md` by following these instructions:
